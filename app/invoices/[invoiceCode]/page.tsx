...
const Page = async ({ params }: { params: { invoiceCode: string } }) => {
    ...
    return (
			<>
				{invoice !== null ? (
					<span>
						<span className="light-blue rounded-[15px] grid md:grid-cols-2 justify-between py-[30px] px-[50px] mb-10">
						...
						<span className="light-blue rounded-[15px] grid md:grid-cols-1 justify-between py-[30px] px-[50px]">
							...
							<span className="blue rounded-t-[15px] grid md:grid-cols-1 justify-between py-[30px] px-[50px]">
							...
							<span className="dark-blue text-white rounded-b-[15px] grid md:grid-cols-1 justify-between py-[50px] px-[60px]">
